...
export async function sendWelcomeEmail(to: string, name: string) {
  ...
  await resend.emails.send({
    from: 'HealthTrack360 <onboarding@resend.dev>',
    to,
          ...
          <div style="padding:32px;">
            ...
            <div style="text-align:center;margin:24px 0;">
              <a href="${process.env.CLIENT_URL || 'http://localhost:3000'}/log"
                style="display:inline-block;background:linear-gradient(135deg,#10b981,#059669);color:white;text-decoration:none;padding:16px 40px;border-radius:14px;font-size:16px;font-weight:700;">
        ...
        <div style="max-width:560px;margin:40px auto;background:linear-gradient(135deg,#0f172a,#1e293b);border-radius:24px;overflow:hidden;border:1px solid rgba(255,255,255,0.08);">
          ...
          <div style="padding:32px;">
            ...
            <div style="text-align:center;margin:32px 0;">
              <a href="${resetUrl}"
                style="display:inline-block;background:linear-gradient(135deg,#3b82f6,#1d4ed8);color:white;text-decoration:none;padding:16px 40px;border-radius:14px;font-size:16px;font-weight:700;">
                🔐 Reset My Password
              </a>
            </div>
            <div style="background:rgba(251,191,36,0.08);border:1px solid rgba(251,191,36,0.2);border-radius:12px;padding:16px;margin-top:24px;">
              <p style="color:#fbbf24;font-size:13px;margin:0;">⚠️ If you didn't request this, ignore this email.</p>
            </div>
          </div>
          <div style="padding:20px 32px;border-top:1px solid rgba(255,255,255,0.05);text-align:center;">
